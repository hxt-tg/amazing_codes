...
simplex_point = s3.project(np.diag([1.1] * 3))
simplex_point_name = ['X', 'Y', 'Z']

simplex_frame = [
    np.vstack((p1, p2)) for p1, p2 in
    combinations([
        s3.project(np.array([[1., 0., 0.]])),
        s3.project(np.array([[0., 1., 0.]])),
        s3.project(np.array([[0., 0., 1.]])),
    ], 2)
]
...
if __name__ == '__main__':
    ...
    print('data (3D) [x, y, z]:\n', data_3d)
    plot_data_on_simplex_s3(data_3d, style='3d_curve')
